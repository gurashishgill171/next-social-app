            ...
            <div className="flex h-full max-h-[40rem] w-full max-w-[64rem] rounded-2xl shadow-2xl">
                <div className="w-full md:w-1/2 p-10 overflow-y-auto">
                    <div className="text-center">
                        <h1 className="text-2xl">Sign up to <span className="font-bold text-[#2168BA]">EduGlobe</span></h1>
                        <p>A global hub for study-abroad aspirants</p>
                    </div>
                    <div className="mt-10 space-y-10">
                        <SignupForm />
                        <Link className="block text-center hover:underline" href={'/login'}>Already have an account? <span className="text-[#2168BA]">Log in</span></Link>
                    </div>
                </div>
